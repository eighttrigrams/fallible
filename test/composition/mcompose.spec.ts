import {isOk, separate, collect, cond, filter, map, assoc, lt, just,
    flow, throws, val, ok, success, right, left, Either, Mapping, Maybe} from 'tsfun'
import {mcompose} from '../../src/composition'
import {liftE, liftM} from '../../src/tuple'
